...
const CircleOfGiving = () => {
  const sponsors = [
    ...
    { id: 3, name: "McGuire", image: "/SponsorshipLogos/3- McGuire.png" },
    {
      id: 4,
    ...
    { id: 6, name: "Keane", image: "/SponsorshipLogos/6- Keane.png" },
    { id: 7, name: "McKenna", image: "/SponsorshipLogos/7- McKenna.png" },
    { id: 8, name: "RP Logo", image: "/SponsorshipLogos/8- RP Logo BLK.png" },
    {
      id: 9,
      name: "Roche Bobois",
      image: "/SponsorshipLogos/9-roche- bobois logo.png",
    },
    { id: 10, name: "BEME", image: "/SponsorshipLogos/10-LOGO_BEME-01.png" },
    {
      id: 11,
      name: "Walter Otero",
      image: "/SponsorshipLogos/11-Walter Otero.png",
    },
    {
      id: 12,
